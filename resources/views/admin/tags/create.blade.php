...
<div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Créer un nouveau tag</h2>
        ...
        <form method="POST" action="{{ route('test.store.tag') }}" class="space-y-6">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Utilisez des mots-clés courts et descriptifs. Évitez les espaces et caractères spéciaux.
                </p>
            </div>
            ...
            <div>
                ...
                <div class="flex items-center">
                    ...
                    <span id="slug-preview" class="text-sm font-medium text-indigo-600 dark:text-indigo-400 ml-1">nom-du-tag</span>
                </div>
            ...
            <div>
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-xs text-gray-500 dark:text-gray-400">Aperçu du tag tel qu'il apparaîtra sur le site</span>
                </div>
            </div>
    ...
    <div class="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Création rapide de plusieurs tags</h3>
        <form method="POST" action="{{ route('simple.multiple.tags') }}" class="space-y-4">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Séparez chaque tag par une virgule. Les doublons seront automatiquement ignorés.
                </p>
            </div>
            <button type="submit" 
    ...
    <div class="mt-6 bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
        <div class="flex">
            ...
            <div>
                <h3 class="text-sm font-medium text-blue-800 dark:text-blue-200">Conseils pour les tags</h3>
                <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                    <ul class="list-disc list-inside space-y-1">
                        <li>Utilisez des mots-clés spécifiques et pertinents</li>
                        <li>Évitez les tags trop génériques comme "article" ou "blog"</li>
                        <li>Un article peut avoir plusieurs tags (contrairement aux catégories)</li>
                        <li>Les tags aident au référencement et à la navigation</li>
                        <li>Réutilisez les tags existants plutôt que d'en créer de nouveaux similaires</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    @if(isset($popular_tags) && $popular_tags->count() > 0)
        <div class="mt-6 bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
            <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-3">Tags populaires existants</h3>
