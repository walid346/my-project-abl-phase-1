...
<div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Modifier le tag</h2>
    ...
    @if($tag->articles_count > 0)
        <div class="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Articles avec ce tag</h3>
            <div class="space-y-3">
                    ...
                    <div class="text-center">
                        <a href="{{ route('admin.articles.index', ['search' => $tag->name]) }}" 
                           class="text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300">
                            Voir tous les articles avec ce tag ({{ $tag->articles_count }})
                        </a>
                    </div>
                @endif
            </div>
    ...
    @if(isset($related_tags) && $related_tags->count() > 0)
        <div class="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Tags similaires</h3>
    ...
    @if($tag->articles_count === 0)
        <div class="mt-6 bg-yellow-50 dark:bg-yellow-900 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4">
            <div class="flex">
                ...
                <div>
                    <h3 class="text-sm font-medium text-yellow-800 dark:text-yellow-200">Tag inutilisé</h3>
                    <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                        Ce tag n'est associé à aucun article. Vous pouvez le supprimer sans impact sur votre contenu.
                    </div>
                    <div class="mt-3">
